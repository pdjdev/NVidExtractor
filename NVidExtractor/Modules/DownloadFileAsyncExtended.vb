' WebClient DownloadFileAsync (with resume support) Module written by Chris001
' http://www.vbforums.com/showthread.php?669162-WebClient-DownloadFileAsync-with-resume-support
' 해당 모듈은 Chris001님이 작성한 위 스레드의 샘플 프로젝트에서 참고하여 가져왔습니다.
